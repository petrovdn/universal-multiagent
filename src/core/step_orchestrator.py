...
- Если в данных есть markdown ссылки в формате [название](url), ОБЯЗАТЕЛЬНО сохрани их в ответе!
- Названия событий календаря, файлов, документов должны быть КЛИКАБЕЛЬНЫМИ ссылками
- Пример: если событие "[Офис](https://www.google.com/calendar/event?eid=abc)", то в ответе пиши "[Офис](https://www.google.com/calendar/event?eid=abc)", а НЕ просто "Офис" или "**Офис**"
- Email-адреса оставляй как есть (они автоматически станут ссылками)
